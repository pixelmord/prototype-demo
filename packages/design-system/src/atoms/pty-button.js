 ...
 */
export class PtyButton extends LitElement {
  ...
  render() {
    ...
    return html`
      <button type="button" class=${classMap(modes)} .disabled=${this.disabled || this.skeleton}>
        <slot></slot>
      </button>
    `;
  }
...
window.customElements.define('pty-button', PtyButton);
